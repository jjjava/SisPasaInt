...
public class Plano extends BaseEntity implements Serializable {
    ...
    @Column(name = "IND_VALOR_FIXO_TITULAR", columnDefinition = ConstantesBanco.SMALLINT)
    private Integer indValorFixoTitular;

    @Column(name = "IND_VALOR_FIXO_AGREGADO", columnDefinition = ConstantesBanco.SMALLINT)
    private Integer indValorFixoAgregado;

    @Column(name = "IND_VALOR_FIXO_DEPENDENTE", columnDefinition = ConstantesBanco.SMALLINT)
    private Integer indValorFixoDependente;

    @Column(name = "IND_ANTES_RN63", columnDefinition = ConstantesBanco.SMALLINT)
    ...
    public boolean naoPermiteAssociacao() {
