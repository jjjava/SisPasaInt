...
public class Convenio extends BaseEntity implements Serializable {
	...
	public ConvenioVO getEntityVO() {
		...
		vo.setEnumTipoPagamento(EnumTipoPagamento.getTipoPagamentoByIndice(tipoPagamento.getId()));
		vo.setEnumTipoParticipacao(EnumTipoParticipacao.getTipoParticipacaoByIndice(tipoParticipacao.getId()));
