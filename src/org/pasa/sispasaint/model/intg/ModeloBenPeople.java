...
public class ModeloBenPeople implements Serializable {
    ...
    public String toString() {
        return "ModeloBenPeople{" + "id=" + id + ", empresa=" + empresa + ", matricula=" + matricula + ", codBeneficiario=" + codBeneficiario + ", direitoAMSCredenciamento=" + direitoAMSCredenciamento + ", dataValidadeCredenciado=" + dataValidadeCredenciado + ", direitoAmsReembolso=" + direitoAmsReembolso + ", dataValidadeReembolso=" + dataValidadeReembolso + ", dataDeAtualizacao=" + dataDeAtualizacao + ", nomeBeneficiarioAbreviado=" + nomeBeneficiarioAbreviado + ", codigoCR=" + codigoCR + ", orgaoPessoal=" + orgaoPessoal + ", vinculo=" + vinculo + ", plano=" + plano + ", faixaNivel=" + faixaNivel + ", dataNascimento=" + dataNascimento + ", direitoAbaterIR=" + direitoAbaterIR + ", nucleoDaAms=" + nucleoDaAms + ", agenciaBancaria=" + agenciaBancaria + ", banco=" + banco + ", contaCorrente=" + contaCorrente + ", dataAdmissao=" + dataAdmissao + ", grauParentesco=" + grauParentesco + ", financeira=" + financeira + ", contratoTrabalho=" + contratoTrabalho + ", sexo=" + sexo + ", empresaAtualizador=" + empresaAtualizador + ", matriculaAtulizador=" + matriculaAtulizador + ", tipoBeneficiario=" + tipoBeneficiario + ", codigoDireitoPasa=" + codigoDireitoPasa + ", grauEscolaridade=" + grauEscolaridade + ", indicadorConclusao=" + indicadorConclusao + ", dataFalecimento=" + dataFalecimento + ", matriculaPasa=" + matriculaPasa + ", nomeDaMae=" + nomeDaMae + ", pis=" + pis + ", cpf=" + cpf + ", empresaOrigem=" + empresaOrigem + ", matriculaOrigem=" + matriculaOrigem + ", empresaPeople=" + empresaPeople + ", matriculaPeople=" + matriculaPeople + ", unidadeDeControle=" + unidadeDeControle + ", centroDeCusto=" + centroDeCusto + ", matriculaParticipante=" + matriculaParticipante + ", matriculaRepresentanteLegal=" + matriculaRepresentanteLegal + ", nomeBeneficiario=" + nomeBeneficiario + ", planoDeReciprocidadeCassi=" + planoDeReciprocidadeCassi + ", codigoNacionalDeSaude=" + codigoNacionalDeSaude + ", declaracaoNascidoVivo=" + declaracaoNascidoVivo + ", cassiData=" + cassiData + ", branco=" + branco + ", codigoFilialVLI=" + codigoFilialVLI + ", nomeArquivo=" + nomeArquivo + '}';
    }
}
