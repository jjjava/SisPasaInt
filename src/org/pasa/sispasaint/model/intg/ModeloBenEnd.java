...
public class ModeloBenEnd implements Serializable{
    ...
    public String toString() {
        return "ModeloBenEnd{" + "id=" + id + ", empresa=" + empresa + ", matricula=" + matricula + ", codBeneficiario=" + codBeneficiario + ", matriculaAtulizador=" + matriculaAtulizador + ", matriculaOrigem=" + matriculaOrigem + ", matriculaPeople=" + matriculaPeople + ", matriculaPasa=" + matriculaPasa + ", matriculaParticipante=" + matriculaParticipante + ", matriculaRepresentanteLegal=" + matriculaRepresentanteLegal + ", direitoAMSCredenciamento=" + direitoAMSCredenciamento + ", dataValidadeCredenciado=" + dataValidadeCredenciado + ", direitoAmsReembolso=" + direitoAmsReembolso + ", dataValidadeReembolso=" + dataValidadeReembolso + ", dataDeAtualizacao=" + dataDeAtualizacao + ", nomeBeneficiarioAbreviado=" + nomeBeneficiarioAbreviado + ", codigoCR=" + codigoCR + ", orgaoPessoal=" + orgaoPessoal + ", vinculo=" + vinculo + ", plano=" + plano + ", faixaNivel=" + faixaNivel + ", dataNascimento=" + dataNascimento + ", direitoAbaterIR=" + direitoAbaterIR + ", nucleoDaAms=" + nucleoDaAms + ", agenciaBancaria=" + agenciaBancaria + ", banco=" + banco + ", contaCorrente=" + contaCorrente + ", dataAdmissao=" + dataAdmissao + ", grauParentesco=" + grauParentesco + ", financeira=" + financeira + ", contratoTrabalho=" + contratoTrabalho + ", sexo=" + sexo + ", empresaAtualizador=" + empresaAtualizador + ", tipoBeneficiario=" + tipoBeneficiario + ", codigoDireitoPasa=" + codigoDireitoPasa + ", grauEscolaridade=" + grauEscolaridade + ", indicadorConclusao=" + indicadorConclusao + ", dataFalecimento=" + dataFalecimento + ", nomeDaMae=" + nomeDaMae + ", pis=" + pis + ", cpf=" + cpf + ", empresaOrigem=" + empresaOrigem + ", empresaPeople=" + empresaPeople + ", unidadeDeControle=" + unidadeDeControle + ", centroDeCusto=" + centroDeCusto + ", nomeBeneficiario=" + nomeBeneficiario + ", planoDeReciprocidadeCassi=" + planoDeReciprocidadeCassi + ", codigoNacionalDeSaude=" + codigoNacionalDeSaude + ", declaracaoNascidoVivo=" + declaracaoNascidoVivo + ", cassiData=" + cassiData + ", branco=" + branco + ", codigoFilialVLI=" + codigoFilialVLI + ", telefone1=" + telefone1 + ", telefone2=" + telefone2 + ", brancos=" + brancos + ", endereco=" + endereco + ", bairro=" + bairro + ", cidade=" + cidade + ", uf=" + uf + ", cep=" + cep + ", nomeArquivo=" + nomeArquivo + '}';
    }
}
